 ...
 */
@WebServlet("/changePasswordLoginServlet")
public class changePasswordLoginServlet extends HttpServlet {
...
//			             response.sendRedirect("./changePassword.jsp");
						 ...
						 //session.setAttribute("Message", expired);
