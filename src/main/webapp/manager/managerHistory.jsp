	...
	<div class="main-content">
		...
		<div class="requestDiv">
            ...
            <table class="table table-striped table-light table-borderless col-12">
                <thead class="table-light head-table col-14">
                    <tr>
                        ...
                        <th class="col-2">Manager Name</th>
                       	...
                       	<th class="col-2">Responded on</th>
...
$(document).ready(function(){
	...
	$("#search-addon").on("click", function () {
	 ...
	 function tableData(jsonData) {
		    ...
		    var empId = "<%= session.getAttribute("empId") %>";
		    var count = 0; // Declare count as a var outside the loop
		    ...
		    if (Object.keys(jsonData).length === 0 && jsonData.constructor === Object) {
		        ...
		        Object.keys(jsonData).forEach((key, index) => {
		            ...
		            if (item["manager_id"] === empId) {
		                // Check if the manager status is approved or rejected
		                if ((item["manager_status"] === "approved") || (item["manager_status"] === "rejected")) {
		                    count++; // Increment count when a matching row is found
		                    ...
		                    for (let i = 0; i < length; i++) {
		                        ...
		                        if (item.self == "yes" && item.receipt[i]) {
