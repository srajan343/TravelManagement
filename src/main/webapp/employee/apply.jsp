                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-middle">
                        ...
                        <tr>
                           ...
                           <td><input type="file" class="form-control receipt" accept=".pdf, image/*" name="receipt[0]" disabled></td>
...
<script>
  ...
  document.getElementById('resetBtn').addEventListener('click', function () {
   ...
   document.getElementById('addRow').addEventListener('click', function () {
    ...
    newRow += "<td><input type='file' class='form-control receipt' name='receipt[" + rowIndex + "]' disabled accept='.pdf, images/*' required></td>";
    ...
    $('#tableBody tr').each(function (index, row) {
        ...
        if (isSelfArranged) {
            ...
            if (receiptInput && receiptInput.files.length > 0) {
                ...
                const uniqueFileName = "file_" + Date.now() + "_" + index + "_" + empId + "." + fileExtension;
